 ...
 */
final class Version20191111210427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE points_team1 points_team1 JSON DEFAULT NULL, CHANGE points_team2 points_team2 JSON DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE points_team1 points_team1 VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE points_team2 points_team2 VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
