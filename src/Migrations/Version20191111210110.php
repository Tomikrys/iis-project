 ...
 */
final class Version20191111210110 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE points_team1 points_team1 VARCHAR(255) DEFAULT NULL, CHANGE points_team2 points_team2 VARCHAR(255) DEFAULT NULL');
