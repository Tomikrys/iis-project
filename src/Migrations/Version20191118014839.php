 ...
 */
final class Version20191118014839 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE team1_id team1_id INT DEFAULT NULL, CHANGE team2_id team2_id INT DEFAULT NULL, CHANGE points_team1 points_team1 JSON NOT NULL, CHANGE points_team2 points_team2 JSON NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE team1_id team1_id INT NOT NULL, CHANGE team2_id team2_id INT NOT NULL, CHANGE points_team1 points_team1 LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin, CHANGE points_team2 points_team2 LONGTEXT DEFAULT NULL COLLATE utf8mb4_bin');
