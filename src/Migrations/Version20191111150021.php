 ...
 */
final class Version20191111150021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE points_team1 points_team1 INT DEFAULT NULL, CHANGE points_team2 points_team2 INT DEFAULT NULL, CHANGE field round INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game CHANGE points_team1 points_team1 INT DEFAULT NULL, CHANGE points_team2 points_team2 INT DEFAULT NULL, CHANGE round field INT NOT NULL');
